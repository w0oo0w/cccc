...
def solve():
    ...
    try:
        ...
        print('ok ip:'+proxy['http'] + ' count:' + success_count)

    except:
        fail_count = fail_count + 1
        print('no' + ' count:' + fail_count)
        try:
...
article_list = getList("https://blog.csdn.net/community/home-api/v1/get-business-list?page=2&size=100&businessType=blog&noMore=false&username=agonie201218")
get_proxy_list()
